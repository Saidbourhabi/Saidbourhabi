...
export const LogoLoop = memo(
  ({
    ...
    const effectiveLogoHeight = isMobile && mobileLogoHeight ? mobileLogoHeight : logoHeight;
    ...
    useResizeObserver(updateDimensions, [containerRef, seqRef], [logos, effectiveGap, effectiveLogoHeight, isVertical]);

    useImageLoader(seqRef, updateDimensions, [logos, effectiveGap, effectiveLogoHeight, isVertical]);
    ...
    const cssVariables = useMemo(
      ...
      [effectiveGap, effectiveLogoHeight, fadeOutColor]
    );
      ...
      (item, key) => {
          ...
          return (
            <li
              className={cx(
                ...
                isVertical ? 'mb-[var(--logoloop-gap)' : 'mr-(--logoloop-gap)',
        ...
        return (
          <li
            className={cx(
              'flex-none text-(length:--logoloop-logoHeight) leading-none',
              isVertical ? 'mb-r(--logoloop-gap)' : 'mr-(--logoloop-gap)',
              scaleOnHover && 'overflow-visible group/item'
            )}
            key={key}
            role="listitem"
